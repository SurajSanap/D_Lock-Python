...
def show_actual_password():
    ...
    password = str(check(hour, minute, day, month, year))
    password_label.config(text="Actual Password: " + password, fg="green")
...
password_label = tk.Label(window, text="Actual Password:", font=("Arial", 12), fg="red")
password_label.pack(pady=10)

# Create the show actual password button
show_password_button = tk.Button(window, text="Show Actual Password", command=show_actual_password, font=("Arial", 10), fg="blue")
